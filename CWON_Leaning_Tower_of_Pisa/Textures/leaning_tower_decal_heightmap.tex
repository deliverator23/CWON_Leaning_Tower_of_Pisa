...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\paperspace\Downloads\leaning_tower_decal_heightmap.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1992537211</m_ExportedTime>
	<m_ClassName text="Decal_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="leaning_tower_decal_heightmap.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="leaning_tower_decal_heightmap"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
